...
const nav = useNav()
const sections = [
  {label:'Start', start:1}, {label:'Reference coach', start:10},
  {label:'Build your coach', start:13}, {label:'Engineering', start:29},
  {label:'Show your work', start:34}, {label:'Optional: use it', start:36},
  {label:'Stay connected', start:46},
]
